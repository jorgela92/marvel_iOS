...
class FooterCell: UITableViewCell {
    ...
    @IBOutlet fileprivate weak var shadowView: UIView! {
        didSet {
            ...
            shadowView.addRoundCornersView(corners: [UIRectCorner.bottomLeft, UIRectCorner.bottomRight], radius: 10.0)
        }
    }
    ...
    @IBOutlet fileprivate weak var borderView: UIView! {
        didSet {
            ...
            borderView.addRoundCornersView(corners: [UIRectCorner.bottomLeft, UIRectCorner.bottomRight], radius: 10.0)
        }
    }
    ...
    @IBOutlet fileprivate weak var containerView: UIView! {
        didSet {
            ...
            containerView.addRoundCornersView(corners: [UIRectCorner.bottomLeft, UIRectCorner.bottomRight], radius: 10.0)
        }
    }
}
